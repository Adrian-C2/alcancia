...
public class TweetToTwitterActivity extends Activity {
	...
	private static final String CONSUMER_SECRET = "KpqqJVoY1W9YVGp8fhMgCISr6Ehalvz0tVohlUZ9A"; // XXX Encode in your app
	...
	private void tweetMessage() {
		try {
			mTwitter.updateStatus("Testing - Tweeting with @Blundell_apps #AndroidDev Tutorial using #Twitter4j http://blog.blundell-apps.com/sending-a-tweet/");
